...
public class Reshape {
    ...
    static final char TASHDEED = 0x0651;

    private static final char charMap[][] = {
            {0x0621, 0x0007, 0x0621, 0xFE80, 0xFE80, 0xFE80},
            ...
            {0x064B, 0x000C, 0x064B, 0xFE70, 0xFE71, 0xFE70, 0xE818, 0xE82A, 0xE823},
            {0x064C, 0x000C, 0x064C, 0xFE72, 0xFE72, 0xFE72, 0xFC5E, 0xE82B, 0xE824},
            {0x064D, 0x000C, 0x064D, 0xFE74, 0xFE74, 0xFE74, 0xFC5F, 0xE82D, 0xFE74},
            {0x064E, 0x000A, 0x064E, 0xFE76, 0xFE77, 0xFE76, 0xFC60, 0xE828, 0xE820},
            {0x064F, 0x000A, 0x064F, 0xFE78, 0xFE79, 0xFE78, 0xFC61, 0xE829, 0xE821},
            {0x0650, 0x000A, 0x0650, 0xFE7A, 0xFE7B, 0xFE7A, 0xFC62, 0xE82C, 0xFE7A},
            {0x0651, 0x000A, 0x0651, 0xFE7C, 0xFE7D, 0xFE7C, 0x0, 0x0, 0xE825},
            {0x0652, 0x000A, 0x0652, 0xFE7E, 0xFE7F, 0xFE7E, 0x0, 0x0, 0xE822},
    ...
    public static String doReshape(String Str) {
        String Temp = " " + Str + " ";
        char pre, at, post;
        ...
        char pre_pre = ' ';
        char pre_tashkeel = ' ';
        int what_case_pre_tashkeel;
        int what_case_post_tashkeel;
        ...
        while (i < len) {
            ...
            pre_tashkeel = pre;
            what_case_pre_tashkeel = what_case_pre;
            what_case_post_tashkeel = what_case_post;
            ...
            int pre_step = 0;
            if (what_case_pre == TASHKEEL || what_case_pre == TANWEEN) {
                pre = pre_pre;
            ...
            switch (which_case & 0x000F) {
                ...
                case RIGHT_LEFT_CHAR_LAM:
                    ...
                    if ((what_case_post & 0x000F) == RIGHT_NOLEFT_CHAR_ALEF) {
                        ...
                        i = i + 2;
	                                   ...
	                                   /* reshapedString.append(getShape(post,pre_step));
	                                    reshapedString.append(getShape(post,2));

	                                    reshapedString.append(getShape(post,2+pre_step));
	                                    reshapedString.append(getShape(post,2+pre_step));
	                                    reshapedString.append(getShape(post,pre_step+2));

	                                    reshapedString.append(getShape(post,3));*/
                        continue;
                    ...
                    } else if (what_case_post == TASHKEEL || what_case_post == TANWEEN) {
                        post_post = Temp.charAt(i + 3);
                        what_case_post_post = getCase(post_post);
                        if (what_case_post_post == TASHKEEL) {
                            post_post = Temp.charAt(i + 4);
                            what_case_post_post = getCase(post_post);
                        }
                ...
                case TANWEEN:
                    //                                		char temp = (char)(what_case_pre&0x000F);
                    //                                		Boolean isover = false;
                    //                                		if(temp == RIGHT_NOLEFT_CHAR_ALEF || temp == RIGHT_LEFT_CHAR_LAM || pre == 0x0621 || pre == 0x0637 || pre == 0x0638 )
                    //                                			isover = true;
                    if (!((what_case_post_tashkeel == TASHKEEL || what_case_post_tashkeel == TANWEEN) && at == TASHDEED))
                        if (pre_tashkeel == TASHDEED)
                            reshapedString.append(getShape(at, 4));
                        else
                            reshapedString.append(getShape(at, 0));
                    i++;
                    pre_pre = pre;
    ...
    public static String doReshape_reverse(String Str) {
        String Temp = " " + Str + "   ";
        char pre, at, post;
        StringBuilder reshapedString = new StringBuilder();
        int i = 0;
    ...
    public static String doReshape_browser(String Str) {
        String Temp = " " + Str + " ";
        char pre, at, post;
        StringBuilder reshapedString = new StringBuilder();
        int i = 0;
    ...
    static int getCase(char ch) {
        if (ch < 0x0621 || ch > 0x06d2)
            ...
            return charMap[(int) ch - 0x0621][1];
    }

    static char getShape(char ch, int which_shape) {
        return charMap[(int) ch - 0x0621][2 + which_shape];
    }
}